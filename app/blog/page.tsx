...
export const metadata: Metadata = {
    ...
    description: 'Expert analysis, market updates, and educational guides on stocks, crypto, and commodities. Stay ahead with data-driven insights.',
    openGraph: {
        title: 'Financial Insights — FinnSays Blog',
        description: 'Expert analysis and educational guides on stocks, crypto, and commodities.',
        type: 'website',
    },
    twitter: {
        card: 'summary_large_image',
        title: 'Financial Insights — FinnSays Blog',
        description: 'Expert analysis and market guides for traders and investors.',
    },
    alternates: {
        canonical: '/blog',
    },
