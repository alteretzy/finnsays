    ...
    return (
        <ErrorBoundary fallback={
            ...
            <main className="relative min-h-screen bg-black overflow-x-hidden">
                ...
                {/* ── Section 1: Hero ─────────────────────────────── */}
                <section className="relative min-h-screen flex items-center px-4 sm:px-6 md:px-12 max-w-[1800px] mx-auto">
                    <div className="relative z-10 w-full grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
                        ...
                        <div>
                            <FadeIn>
                                ...
                                <h1 className="text-3xl sm:text-4xl md:text-6xl xl:text-7xl font-light tracking-tight leading-tight text-white mb-8">
                                    Professional <br />
                            ...
                            <FadeIn delay={0.2}>
                                <p className="text-base md:text-xl text-gray-400 font-light max-w-lg leading-relaxed mb-10">
                        ...
                        <div className="relative h-[300px] sm:h-[400px] md:h-[600px] w-full flex items-center justify-center">
                ...
                <section className="relative py-16 md:py-32 px-4 sm:px-6 md:px-12 max-w-[1800px] mx-auto min-h-screen flex flex-col justify-center overflow-hidden">
                    ...
                    <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        ...
                        <div className="relative group z-[2]">
                            ...
                            <Card className="relative min-h-[400px] md:min-h-[500px] !bg-black/30 !backdrop-blur-none !border-white/[0.08] p-6 md:p-12 flex flex-col justify-between group-hover:!border-white/[0.15] transition-all duration-500" noPadding>
                                <div>
                ...
                <LiveMarketsSection initialData={initialData} />
                ...
                {/* ── CTA Section ─────────────────────────────────── */}
                <section className="relative py-16 md:py-24 lg:py-32 px-4 sm:px-6 md:px-12 border-t border-white/5 overflow-hidden">
                    {/* Background watermark */}
                    <div className="absolute inset-0 flex items-center justify-center pointer-events-none select-none">
                        <span className="text-[60px] sm:text-[100px] md:text-[160px] lg:text-[200px] font-bold uppercase tracking-wider text-transparent" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.03)' }}>
                            FINNSAYS
                        </span>
                    </div>
                    {/* Radial blue glow */}
                    ...
                    <div className="relative max-w-[1800px] mx-auto text-center">
                        <FadeIn>
                            ...
                            <p className="text-white/40 font-light max-w-2xl mx-auto mb-12 leading-relaxed">
                                Institutional-grade market intelligence for stocks, crypto, metals, and commodities.
                                Track 100+ global assets with real-time data, advanced charts, and precision analytics.
                            </p>
