...
export default function Button({
    ...
    const baseStyles =
        'btn-reflection relative inline-flex items-center justify-center font-light uppercase tracking-widest transition-all duration-300 rounded-full focus:outline-none focus:ring-2 focus:ring-[#0055FF]/30';
