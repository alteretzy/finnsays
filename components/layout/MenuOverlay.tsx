        ...
        <AnimatePresence>
            {isOpen && (
                ...
                >
                    ...
                    {/* Menu Content */}
                    <div className="h-full flex flex-col justify-center px-6 sm:px-12 md:px-24">
                            ...
                            {menuItems.map((item, i) => (
                                ...
                                >
                                    <Link href={item.href} onClick={onClose}>
                                        <motion.span
                                            className="text-2xl sm:text-4xl md:text-6xl lg:text-8xl font-light tracking-tight text-white/90 block py-0.5 sm:py-1 group-hover:text-[#0055FF] transition-colors duration-300"
