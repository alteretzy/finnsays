...
export default function Footer() {
    return (
        <footer className="border-t border-white/[0.04] overflow-hidden">
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 md:px-12 py-10 md:py-14">
                ...
                <div className="mt-10 pt-6 border-t border-white/[0.04] flex flex-col md:flex-row items-center justify-between gap-3">
                    ...
                    <p className="text-[11px] text-white/10 font-light">
                        Market data by Yahoo Finance + Finnhub. Not financial advice.
                    </p>
                </div>
            </div>
            ...
            <div className="relative w-full flex justify-center -mb-[40px] md:-mb-[60px] pointer-events-none select-none overflow-hidden">
                <span
                    className="text-[50px] sm:text-[80px] md:text-[120px] lg:text-[160px] font-bold uppercase tracking-[0.1em] text-transparent leading-none transition-all duration-700 ease-out hover:drop-shadow-[0_0_30px_rgba(0,85,255,0.4)]"
                    style={{
                ...
                <span
                    className="absolute inset-0 text-center text-[50px] sm:text-[80px] md:text-[120px] lg:text-[160px] font-bold uppercase tracking-[0.1em] text-[#0055FF] leading-none opacity-0 hover:opacity-10 transition-opacity duration-700"
                >
                    FINNSAYS
                </span>
            </div>
