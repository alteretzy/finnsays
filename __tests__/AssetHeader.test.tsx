...
jest.mock('../components/ui/Button', () => ({ children, onClick }: { children: React.ReactNode, onClick?: () => void }) => <button onClick={onClick}>{children}</button>);
jest.mock('../components/ui/Badge', () => ({ children }: { children: React.ReactNode }) => <div>{children}</div>);
jest.mock('../components/animations/FadeIn', () => ({ children }: { children: React.ReactNode }) => <div>{children}</div>);
